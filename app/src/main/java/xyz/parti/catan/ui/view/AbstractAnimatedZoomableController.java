...
public abstract class AbstractAnimatedZoomableController extends DefaultZoomableController {
    ...
    public void zoomToPoint(
        ...
        CatanLog.d("zoomToPoint: duration %d ms", durationMs);
    ...
    public void setTransform(
            ...
            long durationMs,
            @Nullable Runnable onAnimationComplete) {
        CatanLog.d("setTransform: duration %d ms", durationMs);
        if (durationMs <= 0) {
    ...
    private void setTransformImmediate(final Matrix newTransform) {
        CatanLog.d("setTransformImmediate");
        stopAnimation();
    ...
    public void onGestureUpdate(TransformGestureDetector detector) {
        CatanLog.d("onGestureUpdate %s", isAnimating() ? "(ignored)" : "");
        if (isAnimating()) {
            return;
        }
